...
pa.speed = [0.5  0.25  .125  0.0625]; %speeds m/s

pa.direction = deg2rad([90, 250,270,290, 350]) ; %(0 is radially out horizontally, 90 is forward/up, 270 is backwards/down x-z/x-y plane)
