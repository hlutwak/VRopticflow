...
pa.speed = [0.075,  0.0375, 0.0187]; %speeds m/s

pa.direction = deg2rad([240, 300]) ; %(0 is radially out horizontally, 90 is forward/up, 270 is backwards/down x-z/x-y plane)
